...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_file', type=str, default="codeio_1k_msg_executed.jsonl")
    parser.add_argument('--output_file', type=str, default="codeio_1k_msg_executed_filtered.pkl")
