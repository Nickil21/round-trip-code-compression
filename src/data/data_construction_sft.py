...
if __name__ == "__main__":
    ...
    messages_list = [data for i, data in enumerate(messages_list) if len(inputs[i]) <= 32768]  # filter out messages longer than 32768 characters
    print(f"{org_count-len(messages_list)} inputs longer than 32768 characters")
