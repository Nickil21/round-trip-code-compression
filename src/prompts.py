...
Can you predict a feasible output based on `main_solution_inverse`? Do not include any explanations, reasoning, or extra text. Put your final answer in the following json format: {{"output": <your output>}}, where <your output> should be a dictionary, even if the there is only one output variable, with keys strictly match the output variables' names as specified.

[THOUGHT]
"""

_INPUT_TAIL_NORMAL_END = """
Can you predict a feasible output without writing any code? Do not include any explanations, reasoning, or extra text. Put your final answer in the following json format: {{"output": <your output>}}, where <your output> should be a dictionary, even if the there is only one output variable, with keys strictly match the output variables' names as specified.

[THOUGHT]
"""


INPUT_PRED_TEMPLATE = _EXAMPLE_PREAMBLE + _INPUT_TAIL + _INPUT_TAIL_NORMAL_END
INPUT_PRED_TEMPLATE_INV_EXTRA = _EXAMPLE_PREAMBLE + _INPUT_TAIL + _INPUT_TAIL_INV_EXTRA
